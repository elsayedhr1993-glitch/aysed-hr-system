...
import { calculateWorkingLeaveDays } from '../services/leaveSettlementService';
...
export const LeavesView: React.FC = () => {
  ...
  const [endDate, setEndDate] = useState<string>(new Date(Date.now() + 5 * 24 * 60 * 60 * 1000).toISOString().split('T')[0]);
