...
export const ComplianceSmartSentinelModal: React.FC<ComplianceSmartSentinelModalProps> = ({
  ...
  const [activeTab, setActiveTab] = useState<'OVERVIEW' | 'PAM' | 'WPS' | 'RESIDENCY'>('OVERVIEW');
  ...
  const issuesCount = expiringResidencies.length + unverifiedContracts.length + wpsIssuesCount;
